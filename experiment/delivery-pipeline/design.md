...
|---:|---|---|---|---|
| 1 | Context Intake | read external context, write artifacts | Gemini 3.1 Pro (Preview) medium | context-packet |
...
| 4 | Unit Test + Test Review | read/run tests, write verdict | Gemini 3.1 Pro (Preview) medium | test-verdict |
| 5 | AC-Aware Code Review | read diff, write findings | Claude Opus 4.8 high | code-review-verdict |
| 6 | AC-Aware QA | run app/browser checks, write verdict | Claude Opus 4.8 medium | qa-verdict |
| 7 | AC + Figma UI Validation | browser/Figma validation, write verdict | Claude Opus 4.8 medium | ui-verdict |
| 8 | Create PR | git/GitHub write | Gemini 3.1 Pro (Preview) medium | pr-url + PR metadata |
| 9 | PR Code Review | read PR diff, write findings | Claude Opus 4.8 high | pr-code-review-verdict |
| 10 | QA on PR | preview/browser QA, write verdict | Claude Opus 4.8 medium | pr-qa-verdict |
| 11 | UI Validation on PR | preview/Figma/browser validation | Claude Opus 4.8 medium | pr-ui-verdict |
...
- Use **Gemini 3.1 Pro (Preview)** with `medium` reasoning for synthesis and test review.
- Use **Claude Opus 4.8** with `medium` reasoning for QA or UI validation where browser/Figma evidence needs careful interpretation.
...
{
  "phases": [
    { "id": "context-intake", "command": "commands/01-context-intake.md", "model": "github-copilot/gemini-3.1-pro-preview", "variant": "medium", "writes_code": false },
    ...
    { "id": "test-review", "command": "commands/04-test-review.md", "model": "github-copilot/gemini-3.1-pro-preview", "variant": "medium", "writes_code": false },
    { "id": "code-review", "command": "commands/05-code-review.md", "model": "github-copilot/claude-opus-4.8", "variant": "high", "writes_code": false },
    { "id": "qa", "command": "commands/06-qa.md", "model": "github-copilot/claude-opus-4.8", "variant": "medium", "writes_code": false },
    { "id": "ui-validation", "command": "commands/07-ui-validation.md", "model": "github-copilot/claude-opus-4.8", "variant": "medium", "writes_code": false },
    ...
    { "id": "pr-qa", "command": "commands/10-pr-qa.md", "model": "github-copilot/claude-opus-4.8", "variant": "medium", "writes_code": false },
    { "id": "pr-ui-validation", "command": "commands/11-pr-ui-validation.md", "model": "github-copilot/claude-opus-4.8", "variant": "medium", "writes_code": false }
  ],
  "max_fix_loops": 3
}
```
