...
pre-steps:
  ...
  - name: Verify and fetch previous phase state
    env:
      ...
      EXPECTED_PREVIOUS_WORKFLOWS: .github/workflows/phase-04-test-review.lock.yml
...
- On `status: "pass"`: call the exact `phase_06_qa` safe-output tool (never the generic
