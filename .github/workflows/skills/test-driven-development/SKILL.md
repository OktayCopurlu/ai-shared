...
Follow the imported `references/testing-patterns.md` guidance for naming, priority, mocks, fixtures, Vue stubs, accessibility contracts, and false-positive checks. Follow repository-local test conventions when they conflict with the shared reference.
...
- imported `references/testing-patterns.md` — test structure, anti-patterns, Vue component testing
